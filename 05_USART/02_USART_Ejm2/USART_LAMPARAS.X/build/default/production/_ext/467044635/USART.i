# 1 "../../00_USART_Ejm1/UART.X/USART.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../00_USART_Ejm1/UART.X/USART.c" 2
# 1 "../../00_USART_Ejm1/UART.X/USART.h" 1
...
# 4 "../../00_USART_Ejm1/UART.X/USART.h" 2
...
# 6 "../../00_USART_Ejm1/UART.X/USART.h" 2
...
void USART_init(uint32_t baudios){
    ...
    n=(uint16_t)(((16000000/baudios)/4)-1);
