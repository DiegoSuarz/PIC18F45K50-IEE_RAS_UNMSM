...
_Bool digitalRead(uint8_t pin, uint8_t registro);
_Bool digitalRead1(uint8_t pin, uint8_t registro);
...
void ejemplo5(void)
{
    ...
    while(estado){
        ...
        while(i<contador){
            LATD=0xFF;
            _delay((unsigned long)((300)*(16000000UL/4000.0)));
            LATD=0x00;
            _delay((unsigned long)((300)*(16000000UL/4000.0)));
            i++;
        }
...
void ejemplo6_funcionArduino(void)
{
    if(digitalRead1(0,PORTA)==1){
        while(digitalRead(0,PORTA)==1);
        _delay((unsigned long)((20)*(16000000UL/4000.0)));
        contador++;
        if(contador==255)contador=0;
    ...
    if(digitalRead1(1,PORTA)==0){
        while(digitalRead1(1,PORTA)==0);
        _delay((unsigned long)((20)*(16000000UL/4000.0)));
        contador--;
        if(contador==255)contador=0;
