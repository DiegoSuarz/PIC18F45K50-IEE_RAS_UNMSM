...
void __attribute__((picinterrupt(("high_priority"))))ISR1(){
    if(INTCONbits.INT0F==1 ){
        INTCONbits.INT0F=0;
        MostrarDisplay01(Display7segDecoded,sizeof(Display7segDecoded)/sizeof(Display7segDecoded[0]));
    }
...
void __attribute__((picinterrupt(("low_priority"))))ISR2(){
    if(INTCON3bits.INT1F){
        INTCON3bits.INT1F=0;
        MostrarDisplay02(Display7segDecoded,sizeof(Display7segDecoded)/sizeof(Display7segDecoded[0]));
    }
}
